            ...
            <select name="querySupplierId">
                <c:if test="${supplierList != null }">
                    ...
                    <c:forEach var="supplier" items="${supplierList}">
                        <option
                                <c:if test="${supplier.id == querySupplierId }">selected="selected"</c:if>
    ...
    <table class="supplierTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="storageRecord" items="${storageRecordList}" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a class="viewStorageRecord" href="javascript:;"
                             storageRecordId=${storageRecord.id } StorageRecordcc=${storageRecord.srCode }><img
                            src="${pageContext.request.contextPath }/statics/images/view.png" alt="查看" title="查看"/></a></span>
                    <span><a class="modifyStorageRecord" href="javascript:;"
                             storageRecordId=${storageRecord.id } StorageRecordcc=${storageRecord.srCode }><img
                            src="${pageContext.request.contextPath }/statics/images/upd.png" alt="修改"
                            title="修改"/></a></span>
                    <span><a class="deleteStorageRecord" href="javascript:;"
                             storageRecordId=${storageRecord.id } StorageRecordcc=${storageRecord.srCode }><img
