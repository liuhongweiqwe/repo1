    ...
    <table class="supplierTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="supplier" items="${supplierList }" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a class="viewSupplier" href="javascript:;"
                             supId=${supplier.id } supName=${supplier.supName }><img
                            src="${pageContext.request.contextPath }/statics/images/view.png" alt="查看" title="查看"/></a></span>
                    <span><a class="modifySupplier" href="javascript:;"
                             supId=${supplier.id } supName=${supplier.supName }><img
                            src="${pageContext.request.contextPath }/statics/images/upd.png" alt="修改"
                            title="修改"/></a></span>
                    <span><a class="deleteSupplier" href="javascript:;"
                             supId=${supplier.id } supName=${supplier.supName }><img
