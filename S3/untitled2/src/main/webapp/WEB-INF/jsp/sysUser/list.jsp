    ...
    <table class="supplierTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="user" items="${page.datas }" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a class="viewUser" href="javascript:;" userid=${user.id } account=${user.account }><img
                            src="${pageContext.request.contextPath }/statics/images/view.png" alt="查看" title="查看"/></a></span>
                    <span><a class="modifyUser" href="javascript:;" userid=${user.id } account=${user.account }><img
                            src="${pageContext.request.contextPath }/statics/images/upd.png" alt="修改"
                            title="修改"/></a></span>
                    <span><a class="deleteUser" href="javascript:;" userid=${user.id } account=${user.account }><img
